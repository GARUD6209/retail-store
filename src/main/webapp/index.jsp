...
<body>
	...
	<div class="hero">
		<div class="hero-content">
			...
			<p style="color: black;">Streamline your billing process with our
				powerful tools. Efficiently manage all your bills in one place.</p>
	...
	<div class="content">
		<section class="features">
			<div class="feature">
				...
				<p>Keep an eye on all your bills and their due dates, so you
					never miss a payment.</p>
			</div>
			<div class="feature">
				<h3>Easy Payments</h3>
				<p>Pay your bills quickly and securely with our integrated
					payment options.</p>
			</div>
			<div class="feature">
				<h3>Detailed Reports</h3>
				<p>Generate detailed reports to get insights into your spending
					patterns.</p>
			</div>
		</section>
	</div>
