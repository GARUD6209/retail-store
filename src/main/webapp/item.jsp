                ...
                <div class="col">
                    ...
                    <form action="items" method="post" class="mt-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" id="currentPrice" name="current-price" placeholder="Price" required>
                        </div>
                        <div class="form-group">
                    ...
                    <form action="items" method="post" class="mt-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="editName" name="name" value="<%=editItemDTO.getName() %>">
                        </div>
                        <div class="form-group">
                            <label for="editPrice">Price</label>
                            <input type="text" class="form-control" id="editPrice" name="current-price" value="<%=editItemDTO.getCurrent_price() %>">
                        </div>
                        <div class="form-group">
                            <label for="editDescription">Description</label>
                            <input type="text" class="form-control" id="editDescription" name="description" value="<%=editItemDTO.getDescription() %>">
                        </div>
